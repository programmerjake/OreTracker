...
orehud.ignore_set = {
    ...
    ["nssm:web"] = true,
    ["pmb_soil:dirt_with_grass"] = true,
    ["pmb_soil:dirt"] = true,
    ["pmb_soil:forest_grass"] = true,
    ["pmb_soil:grass_variant_1"] = true,
    ["pmb_soil:grass_variant_2"] = true,
    ["pmb_soil:grass_variant_3"] = true,
    ["pmb_soil:gravel"] = true,
    ["pmb_stone:bedrock"] = true,
    ["pmb_stone:cobble_moss_1"] = true,
    ["pmb_stone:cobble_moss_2"] = true,
    ["pmb_stone:cobble"] = true,
    ["pmb_stone:granite"] = true,
    ["pmb_stone:limestone"] = true,
    ["pmb_stone:stone"] = true,
